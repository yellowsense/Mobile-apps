...
const Support = ({navigation}) => {
  const phoneNumber = 'tel:+9403890108';
  const emailAddress = 'support@yellowsense.in';
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={handlePhonePress}>
        <View style={styles.supportInfoView}>
          <View style={styles.supportInfoImageView}>
            <Image
              source={require('../Assets/support_phone.png')}
      ...
      <TouchableOpacity onPress={handleEmailPress}>
        <View style={styles.supportInfoView}>
          <View style={styles.supportInfoImageView}>
            <Image
              source={require('../Assets/support_mail.png')}
              style={styles.supportInfoImage}
            />
          </View>
          ...
          <View style={styles.supportInfoTextView}>
            ...
            <Text style={styles.supportInfoText}>{emailAddress}</Text>
          </View>
        </View>
      </TouchableOpacity>
    </View>
