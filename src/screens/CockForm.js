    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={styles.bookView}>
          ...
          <Text style={styles.bookText}>Book a Cook</Text>
        </View>

        <View style={styles.services}>
          <Text style={styles.servicesText}>No. of Members in House</Text>
        </View>
        ...
        <View style={styles.services}>
          <Text style={styles.servicesText}>Cooking Options</Text>
        </View>
        ...
        <View style={[styles.TxtInptContainer]}>
          <Dropdown
            ...
            labelField="value"
            valueField="key"
            placeholder={cookingOption ? cookingOption : 'Select---'}
            searchPlaceholder="Search Here..."
            value={cookingOption}
            //   search
            onChange={item => {
              console.log('90===', item.value);
              setcookingOption(item.value);
            }}
            renderItem={renderItem}
          />
        </View>
        ...
        <View style={styles.services}>
          <Text style={styles.servicesText}>Speciality</Text>
        </View>
        ...
        <View style={[styles.TxtInptContainer]}>
          <Dropdown
            ...
            labelField="value"
            valueField="key"
            placeholder={SpecialityType ? SpecialityType : 'Select---'}
            searchPlaceholder="Search Here..."
            value={SpecialityType}
            //   search
            onChange={item => {
              console.log('90===', item.value);
              setSpecialityType(item.value);
            }}
            renderItem={renderItem}
          />
        </View>
